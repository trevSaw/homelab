...
## Overview
- Purpose: Subtitle companion for Sonarr/Radarr
- Category: Media
...
## Repository Location
- Service directory: `services/bazarr/`
- Compose file: `services/bazarr/compose.yaml`
- Documentation path: `Documentation/services/bazarr/bazarr.md`

## Runtime Information
- Container names: bazarr
...
## Known Issues
- See `Validation/Phase10.75/bazarr/Diff.md` for live-vs-CasaOS differences captured at import.
