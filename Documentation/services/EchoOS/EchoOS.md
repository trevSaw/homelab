...
## Repository Location
- Service directory: `homelab/Services/EchoOS.md`
- Compose file: Not documented — requires future operational definition.
- Documentation path: `homelab/Documentation/services/EchoOS/EchoOS.md`
...
- Dependencies: proxy (Traefik), ai_net (shared with AI services)
...
- Known risks: R1: Duplicate service names (case‑insensitive);R2: Missing healthchecks;R3: Absent resource limits
