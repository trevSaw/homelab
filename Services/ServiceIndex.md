...
| Service | Category | Status | Priority | Last Reviewed | Documentation | Deployment | Alternatives | GitHub | Purpose | Notes |
|---------|----------|--------|----------|---------------|---------------|------------|--------------|--------|---------|-------|
| Ollama | LLM Runtime | Production | Critical | — | [homelab/docs/services/Ollama.md](../../homelab/docs/services/Ollama.md) | [homelab/compose/ai/ollama-openwebui/](../../homelab/compose/ai/ollama-openwebui/) | llama.cpp | https://github.com/ollama/ollama | Local LLM inference | Uses T400 GPU |
