...
| KORA Runtime | AI Conductor | Production | Critical | 2026-08-03 | [services/kora/README.md](../services/kora/README.md) | [services/kora/](../services/kora/) | — | — | Solo conductor + Phase 14.2A foundation | `AI/KORA/Runtime` |
| Event Bus | Internal Messaging | Logical service | High | 2026-08-03 | [services/event-bus/README.md](../services/event-bus/README.md) | Co-located in KORA | NATS, Redis Streams | — | General internal KORA messaging | In-process Phase 14.2A adapter; no persistence |
| Memory Runtime | Memory Governance | Logical service | High | 2026-08-03 | [services/memory-runtime/README.md](../services/memory-runtime/README.md) | Co-located in KORA | Honcho adapter later | — | Ephemeral proposal lifecycle | No durable writes in Phase 14.2A |
